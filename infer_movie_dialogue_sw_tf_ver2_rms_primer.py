...
import tf_ver2_gpt_rms_primer as tf_gpt
...
model_ckpt_dir  = "TF_Models/dialogue_sw_gpt_rms_primer"
train_loss_file = "train_loss_dialogue_sw_gpt_rms_primer.csv"
...
print("-" * 50)
print("Testing the GPT Primer Network", 
