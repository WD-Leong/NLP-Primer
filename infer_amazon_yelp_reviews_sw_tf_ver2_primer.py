...
import tf_ver2_gpt_primer_v1 as tf_gpt
...
model_ckpt_dir  = "TF_Models/amazon_yelp_sw_gpt_primer"
train_loss_file = "train_loss_amazon_yelp_sw_gpt_primer.csv"
...
print("-" * 50)
print("Inferring the GPT Primer Network", 
      "(" + str(n_iter) + " iterations).")
print("-" * 50)

while True:
    tmp_phrase = input("Enter the prompt: ")
